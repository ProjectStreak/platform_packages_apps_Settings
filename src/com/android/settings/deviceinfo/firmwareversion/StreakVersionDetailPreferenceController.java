...
public class StreakVersionDetailPreferenceController extends BasePreferenceController {

    private static final String TAG = "StreakVersionDialogCtrl";
    private static final int DELAY_TIMER_MILLIS = 500;
    private static final int ACTIVITY_TRIGGER_COUNT = 3;

    private static final String KEY_STREAK_VERSION_PROP = "ro.streak.version";
    ...
    public StreakVersionDetailPreferenceController(Context context, String key) {
        super(context, key);
